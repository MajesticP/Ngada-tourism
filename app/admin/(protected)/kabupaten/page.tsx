...
export default async function AdminKabupatenPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-3xl text-forest-900">Data Kabupaten</h1>
        <p className="text-forest-500 text-sm mt-1">{kabupaten.length} kabupaten terdaftar di Kabupaten Ngada</p>
      </div>
      <KabupatenManager
